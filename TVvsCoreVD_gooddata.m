...
title('TV v.s. CoreVD, Bad data excluded, Saline');
...
colormap(map);
set(gca, 'LineWidth', 2, 'FontSize', 20);
title('TV v.s. CoreVD, Bad data excluded, RT');
xlabel('Tumor Volume (mm^3)');  ylabel('Core Vessel Density (%)')
...
colorbar('Ticks',0:0.14285:1,'TickLabels',{'Day 0','Day 10','Day 20','Day 30','Day 40','Day 50','Day 60','Day 70'});
set(gcf, 'PaperPositionMode', 'Auto');
print(gcf, 'TVvsCoreVD_gooddata_RT.eps', '-depsc2');
...
colormap(map);
set(gca, 'LineWidth', 2, 'FontSize', 20);
title('TV v.s. CoreVD, Bad data excluded, GNP+RT');
xlabel('Tumor Volume (mm^3)');  ylabel('Core Vessel Density (%)')
...
colorbar('Ticks',0:0.14285:1,'TickLabels',{'Day 0','Day 10','Day 20','Day 30','Day 40','Day 50','Day 60','Day 70'});
set(gcf, 'PaperPositionMode', 'Auto');
print(gcf, 'TVvsCoreVD_gooddata_GNP+RT.eps', '-depsc2');
...
colormap(map);
set(gca, 'LineWidth', 2, 'FontSize', 20);
title('Normalized TV v.s. CoreVD, Bad data excluded, Saline');
...
colorbar('Ticks',0:0.14285:1,'TickLabels',{'Day 0','Day 10','Day 20','Day 30','Day 40','Day 50','Day 60','Day 70'});
set(gcf, 'PaperPositionMode', 'Auto');
print(gcf, 'TVnormvsCoreVD_gooddata_Saline.eps', '-depsc2');
...
colormap(map);
set(gca, 'LineWidth', 2, 'FontSize', 20);
title('Normalized TV v.s. CoreVD, Bad data excluded, RT');
xlabel('Normalized Tumor Volume');  ylabel('Core Vessel Density (%)')
...
colorbar('Ticks',0:0.14285:1,'TickLabels',{'Day 0','Day 10','Day 20','Day 30','Day 40','Day 50','Day 60','Day 70'});
set(gcf, 'PaperPositionMode', 'Auto');
print(gcf, 'TVnormvsCoreVD_gooddata_RT.eps', '-depsc2');
...
colormap(map);
set(gca, 'LineWidth', 2, 'FontSize', 20);
title('Normalized TV v.s. CoreVD, Bad data excluded, GNP+RT');
xlabel('Normalized Tumor Volume');  ylabel('Core Vessel Density (%)')
...
colorbar('Ticks',0:0.14285:1,'TickLabels',{'Day 0','Day 10','Day 20','Day 30','Day 40','Day 50','Day 60','Day 70'});
set(gcf, 'PaperPositionMode', 'Auto');
print(gcf, 'TVnormvsCoreVD_gooddata_GNP+RT.eps', '-depsc2');
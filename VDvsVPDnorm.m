    ...
    if k == 3 %Saline
        for l = 1:9
            if VPDnorm50(k,l) == 0
                ...
                color = colors(d+1,:);
                figure(61); hold on;
                h1(i1) = plot(VDens(k+1,l+1),VPDnorm50(k,l),'o','MarkerEdgeColor','k','MarkerFaceColor',color,'MarkerSize',20);
                hold off;
%                 figure(64); hold on;
    ...
    elseif k == 5
        for l = 1:9
            if VPDnorm50(k,l) == 0
                ...
                color = colors(d+1,:);
                figure(61); hold on;
                h1(i1) = plot(VDens(k+1,l+1),VPDnorm50(k,l),'^','MarkerEdgeColor','k','MarkerFaceColor',color,'MarkerSize',20);
                hold off;
%                 figure(64); hold on;
    ...
    elseif k == 8
        for l = 1:9
            if VPDnorm50(k,l) == 0
                ...
                color = colors(d+1,:);
                figure(61); hold on;
                h1(i1) = plot(VDens(k+1,l+1),VPDnorm50(k,l),'s','MarkerEdgeColor','k','MarkerFaceColor',color,'MarkerSize',20);
                hold off;
%                 figure(64); hold on;
    ...
    elseif k == 1 %RT
        for l = 1:9
            if VPDnorm50(k,l) == 0
                ...
                color = colors(d+1,:);
                figure(62); hold on;
                h2(i2) = plot(VDens(k+1,l+1),VPDnorm50(k,l),'o','MarkerEdgeColor','k','MarkerFaceColor',color,'MarkerSize',20);
                hold off;
%                 figure(65); hold on;
    ...
    elseif k == 4
        for l = 1:9
            if VPDnorm50(k,l) == 0
                ...
                color = colors(d+1,:);
                figure(62); hold on;
                h2(i2) = plot(VDens(k+1,l+1),VPDnorm50(k,l),'^','MarkerEdgeColor','k','MarkerFaceColor',color,'MarkerSize',20);
                hold off;
%                 figure(65); hold on;
    ...
    elseif k == 9
        for l = 1:9
            if VPDnorm50(k,l) == 0
                ...
                color = colors(d+1,:);
                figure(62); hold on;
                h2(i2) = plot(VDens(k+1,l+1),VPDnorm50(k,l),'s','MarkerEdgeColor','k','MarkerFaceColor',color,'MarkerSize',20);
                hold off;
%                 figure(65); hold on;
    ...
    elseif k == 2 %GNP+RT
        for l = 1:9
            if VPDnorm50(k,l) == 0
                ...
                color = colors(d+1,:);
                figure(63); hold on;
                h3(i3) = plot(VDens(k+1,l+1),VPDnorm50(k,l),'o','MarkerEdgeColor','k','MarkerFaceColor',color,'MarkerSize',20);
                hold off;
%                 figure(66); hold on;
    ...
    elseif k == 6
        for l = 1:9
            if VPDnorm50(k,l) == 0
                ...
                color = colors(d+1,:);
                figure(63); hold on;
                h3(i3) = plot(VDens(k+1,l+1),VPDnorm50(k,l),'^','MarkerEdgeColor','k','MarkerFaceColor',color,'MarkerSize',20);
                hold off;
%                 figure(66); hold on;
    ...
    elseif k == 7
        for l = 1:9
            if VPDnorm50(k,l) == 0
                ...
                color = colors(d+1,:);
                figure(63); hold on;
                h3(i3) = plot(VDens(k+1,l+1),VPDnorm50(k,l),'s','MarkerEdgeColor','k','MarkerFaceColor',color,'MarkerSize',20);
                hold off;
%                 figure(66); hold on;
...
title('VD v.s. Normalized VPD_{50}, Saline');
...
print(gcf, 'VDvsVPDnorm50_Saline.eps', '-depsc2');
...
%colormap jet;
set(gca, 'LineWidth', 2, 'FontSize', 20);
title('VD v.s. Normalized VPD_{50}, RT');
xlabel('Vessel Density (%)');  ylabel('Normalized VPD_{50} (%)');
...
colorbar('Ticks',0:0.14285:1,'TickLabels',{'Day 0','Day 10','Day 20','Day 30','Day 40','Day 50','Day 60','Day 70'});
set(gcf, 'PaperPositionMode', 'Auto');
print(gcf, 'VDvsVPDnorm50_RT.eps', '-depsc2');
...
%colormap jet;
set(gca, 'LineWidth', 2, 'FontSize', 20);
title('VD v.s. Normalized VPD_{50}, GNP+RT');
xlabel('Vessel Density (%)');  ylabel('Normalized VPD_{50} (%)');
...
colorbar('Ticks',0:0.14285:1,'TickLabels',{'Day 0','Day 10','Day 20','Day 30','Day 40','Day 50','Day 60','Day 70'});
set(gcf, 'PaperPositionMode', 'Auto');
print(gcf, 'VDvsVPDnorm50_GNP+RT.eps', '-depsc2');